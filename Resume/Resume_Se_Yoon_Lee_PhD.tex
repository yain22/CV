...
\address{1002 Neubauer Cir, IL, 60046, U.S.A.} % Main address
...
\begin{rSection}{Professional Summary}
		\item[$\cdot$] An experienced statistician with 5 years of experience in the healthcare industry, including permanent employment and internships. Extensive experience in study designs, statistical operations, and scientific publications across a broad range of therapeutic areas, including cardiovascular disease, oncology, and ophthalmology
...
\begin{rSubsection}{
		\href{https://www.abbvie.com/}{AbbVie.}
	}{\em Feb 2025 -- present}{\textbf{Manager, Statistics (Permanent Employment)}}{\em North Chicago, IL}
	\item Specialized in real-world data analysis and causal inference methods for regulatory and observational research.
	\item Specialized in developing simulation-based R programs for power and sample size calculation in Phase II and Phase III oncology trial designs at the regulatory submission level.
	\item Researched modern causal inference methods, including targeted maximum likelihood estimation, doubly robust estimation, and external control methodologies for clinical trial applications.
	\item Presented methodological research at statistical conferences, including JSM, on topics such as survival extrapolation, multiple imputation, and innovative clinical trial design.
\end{rSubsection}

\begin{rSubsection}{
\href{https://www.edwards.com/}{Edwards Lifesciences.}
}{\em May 2023 -- Jan 2025}{\textbf{Manager, Biostatistics (Permanent Employment)}}{\em Irvine, CA}
...
%{Hyung-Kyu Chae, Hyun Jeong Hong, \underline{\textbf{Se Yoon Lee}}, Jung-Hoon Park, Woo Joo Choi, Seungkuk Oh, Seoyeoun Ji, Yeon-Jung Hong. (2022)``Factors Affecting the Outcome of Medical Treatment in Cats with Obstructive Ureteral Stones Treated with Tamsulosin: 70 Cases (2018–2022), ''} \textit{Veterinary Sciences} 
%\item[] [10]
%\href{https://www.mdpi.com/2306-7381/10/6/395}{Hyung-Kyu Chae, Ju-Yeon Jeong, \underline{\textbf{Se Yoon Lee}}, Hyun-Min Hwang, Kyoung-In Shin, Jung-Hoon Park, Seo-yeoun Ji, Yeon-Jung Hong. (2023)``Clinical Outcomes in Dogs Undergoing Cholecystectomy via a Transverse Incision: A Meta-Analysis of 121 Animals Treated between 2011 and 2021, ''} \textit{Veterinary Sciences} 
\item[] [9]
...
{\underline{\textbf{Se Yoon Lee}}, Peng Zhao, Debdeep Pati, Bani K. Mallick. (2025)
	``Tail-adaptive Bayesian Shrinkage''}, \textit{Electronic Journal of Statistics}
\item[] [14]
\href{https://onlinelibrary.wiley.com/doi/abs/10.1002/sim.70165}
{\underline{\textbf{Se Yoon Lee}}. (2025)
	``A note on the sample size formula for a win ratio endpoint'}, \textit{Statistics in Medicine}
\item[] [15]
	\href{https://www.tandfonline.com/doi/full/10.1080/10543406.2025.2575940}
	{\underline{\textbf{Se Yoon Lee}}. (2025)
		``Power priors and type I error control: constrained borrowing of external control data}, \textit{Journal of Biopharmaceutical Statistics}
\item[] [16]
		\href{https://journals.sagepub.com/doi/abs/10.1177/09622802261427024}
		{\underline{\textbf{Se Yoon Lee}}. (2026)
			``Asymptotic validity of Schoenfeld’s sample size formula for the Cox proportional hazards model via the Wald test approach'}, \textit{Statistical Methods in Medical Research}
\end{rSubsection}
...
\begin{rSection}{Professional Activities}
	\begin{rSubsection}{
		...
		\item \href{https://link.springer.com/journal/12874}{BMC Medical Research Methodology} (Impact Factor: 3.4)		
	\end{rSubsection}
\begin{rSubsection}{
