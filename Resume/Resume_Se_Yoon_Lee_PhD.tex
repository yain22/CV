...
\usepackage[left=0.65in,top=0.70in,right=0.65in,bottom=0.70in]{geometry} % Document margins
\usepackage{hyperref}
\usepackage{color}
\name{Se Yoon Lee} % Your name
\address{
1001 Harvey Rd Apt 68, College Station, Texas, 77840, U.S.A.
$\diamond$
979 888 4107
}
\address{
seyoonlee@stat.tamu.edu
$\diamond$
...
\textbf{Clinical Pharmacology, Cancer Genomics, Applied Statistics, Bayesian Analysis}
\end{rSection}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{rSubsection}{Published/Accepted}{}{}{}
...
\item[] [6]
\href{https://arxiv.org/abs/2008.01006}
