...
\textbf{Clinical Trials, Bayesian Analysis, Adaptive Designs, Survival Analysis, Machine Learning}
\end{rSection}
...
\item Developed Bayesian adaptive clinical trials designs to evaluate the safety and effectiveness of medical devices (Bayesian basket trial designs, power-prior designs, etc).
