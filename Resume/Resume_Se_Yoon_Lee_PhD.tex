...
{\underline{\textbf{Se Yoon Lee}}. (2024)
	``Using Bayesian Statistics in Confirmatory Clinical Trials in the Regulatory Setting: A Tutorial Review''} \textit{Accepted to BMC Medical Research Methodology (to appear)} 
\end{rSubsection}
