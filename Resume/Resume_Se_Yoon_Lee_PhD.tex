...
\name{Se Yoon Lee, Ph.D.} % Your name to appear at the top
...
\begin{document}
	...
	\begin{rSection}{Research interest}
		Causal Inference, Semiparametric Efficiency Thoery, BayesianAnalysis, Clinical Trials, Biostatistics, ML/AI
	\end{rSection}
	...
	\begin{rSection}{Publications}
		%%%%%%%%%%%%%%%%%%%%%%%%%%%
		\begin{rSubsection}{Journal Article (*: corresponding author)}{}{}{}
			...
			%{Hyung-Kyu Chae, Ju-Yeon Jeong, \underline{\textbf{Se Yoon Lee}}, Hyun-Min Hwang, Kyoung-In Shin, Jung-Hoon Park, Seo-yeoun Ji, Yeon-Jung Hong$^{*}$. (2023)
				%``Clinical Outcomes in Dogs Undergoing Cholecystectomy via a Transverse Incision: A Meta-Analysis of 121 Animals Treated between 2011 and 2021, ''} \textit{Veterinary Sciences} 
			\item[] [9]
			...
			{\underline{\textbf{Se Yoon Lee}$^{*}$}, Peng Zhao, Debdeep Pati, Bani K. Mallick. (2024) ``Tail-adaptive Bayesian Shrinkage'', \textit{Electronic Journal of Statistics}}
			\item[] [14]
			\href{https://onlinelibrary.wiley.com/doi/full/10.1002/sim.70165}
			{\underline{\textbf{Se Yoon Lee}$^{*}$}. (2025) ``A note on the sample size formula for a win ratio endpoint'', \textit{Statistics in Medicine}}
			\item[] [15]
			\href{https://www.tandfonline.com/doi/abs/10.1080/10543406.2025.2575940}
			{\underline{\textbf{Se Yoon Lee}$^{*}$}. (2025) ``Power priors and type I error control: constrained borrowing of external control data'', \textit{Journal of Biopharmaceutical Statistics}}
			\item[] [16]
			\href{https://journals.sagepub.com/doi/abs/10.1177/09622802261427024}
			{\underline{\textbf{Se Yoon Lee}$^{*}$}. (2026) ``Asymptotic validity of Schoenfeld’s sample size formula for the Cox proportional hazards model via the Wald test approach'', \textit{Statistical Methods in Medical Research}}
			\item[] [17]
			\href{https://icml.cc/virtual/2026/poster/62031}
			{\underline{\textbf{Se Yoon Lee}$^{*}$} and Jae Kwang Kim. (2026) ``MEC: Machine-Learning-Assisted Generalized Entropy Calibration for Semi-Supervised Mean Estimation'', \textit{Forty-third International Conference on Machine Learning (Just Accepted; Among 23,918 reviewed submissions, of which 6,352 were accepted, corresponding to an acceptance rate of 26.6\%)}}
		\end{rSubsection}
		%%%%%%%%%%%%%%%%%%%%%%%%%%%
