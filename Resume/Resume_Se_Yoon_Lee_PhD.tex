...
``Optimization of dose selection using multiple surrogates of toxicity as continuous variable in Phase I cancer trial," \textit{Contemporary Clinical Trials} [\underline{To appear}]
\end{rSubsection}
