...
``Eliciting the discount parameter in a power prior method on the basis of the type I error	consideration, ''} \textit{Statistics in Biopharmaceutical Research (just accepted, to appear)}
\end{rSubsection}
