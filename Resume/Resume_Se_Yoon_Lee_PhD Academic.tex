...
{\underline{\textbf{Se Yoon Lee}$^{*}$}, Peng Zhao, Debdeep Pati, Bani K. Mallick. (2024+) ``Tail-adaptive Bayesian Shrinkage'', \textit{Major revision invited for Electronic Journal of Statistics} [Preprint]}
[\textbf{Q1}]
\end{rSubsection}
...
\begin{rSubsection}{Under Review}{}{}{}
	...
	\item[] [2]
	\href{}{\underline{\textbf{Se Yoon Lee}$^{*}$}. (2024+)
		``A Note on the Sample Size Formula for a Win Ratio Endpoint by Yu and Ganju, ''} \textit{Submitted (contact me for the preprint)}
\end{rSubsection}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
