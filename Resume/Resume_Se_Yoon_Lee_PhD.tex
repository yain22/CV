...
\address{
One Amgen Center Dr, B38/4A, Thousand Oaks, CA, 91320
$\diamond$
979 888 4107
}
\address{
...
\textbf{Bayesian Analysis, Survival Analysis, Deep Learning, Pharmacometrics, Clinical Pharmacokinetics}
\end{rSection}
...
}{\em May 2021 -- present}{\textbf{Scientist - Clinical Pharmacology, Modeling \& Simulations}}{\em Thousand Oaks, CA}
\item 
Utilized clinical pharmacology and exposure-biomarker-efficacy/safety relationship to guide the development and effective use of medicine.
\end{rSubsection}
...
``Optimization of dose selection using multiple surrogates of toxicity as continuous variable in Phase I cancer trial"
\end{rSubsection}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{rSection}
