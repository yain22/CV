...
Bayesian Analysis, Bayesian Adaptive Design, Bayesian High-dimensional Statistical Modeling, Spatial Statistics
\end{rSection}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{rSubsection}{Journal Article (*: corresponding author / Q1 (best),2,3,4: SJR Quartile)}{}{}{}
...
{\underline{\textbf{Se Yoon Lee}$^{*}$}, Peng Zhao, Debdeep Pati, Bani K. Mallick. (2024+) ``Tail-adaptive Bayesian Shrinkage'', \textit{Electronic Journal of Statistics} (Accepted in 10/23/2024, To Appear, Manuscript No EJS2317) [Preprint]}
;
\href{https://github.com/yain22/Tail-adaptive-Bayesian-Shrinkage}{\underline{\textbf{[Github]}}}
[\textbf{Q1}]
\end{rSubsection}
...
\begin{rSubsection}{Under Review}{}{}{}
	...
	\href{}{\underline{\textbf{Se Yoon Lee}$^{*}$}. (2024+)
		``Constrained borrowing of external control data based on type I error consideration in a power prior method, ''} \textit{Submitted (contact me for the preprint)}
	\item[] [2]
	\href{}{\underline{\textbf{Se Yoon Lee}$^{*}$}. (2024+)
		``A Note on the Sample Size Formula for a Win Ratio Endpoint by Yu and Ganju, ''} \textit{Major Revision invited to Contemporary Clinical Trials Communications (contact me for the preprint)}
\end{rSubsection}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
